...
def main():
    ...
    pygame.display.set_caption('Jogo_Memória : matheomarcon0@gmail.com')
    BASICFONT = pygame.font.Font('freesansbold.ttf', 36)

    #Carregando imagens
    GEMIMAGES = []
    for i in range(1, NUMGEMIMAGES+1):
        gemImage = pygame.image.load('gem%s.jpeg' % i)
...
def runGame():
    ...
    #Jogo através de uma única vez, ao sair você reinicia.
    ...
    while True: 
        ...
        if gameIsOver:
            if clickContinueTextSurf == None:
                ...
                clickContinueTextSurf = BASICFONT.render('Pontuacao:%s(click para continuar)' % (score), 1, GAMEOVERCOLOR, GAMEOVERBGCOLOR)
